...
/**
 * Created by tjh on 2018/8/29.
 */
public class TestUploadInvoice {

    public static String getRequestJson() {
        JSONObject req = new JSONObject();

        req.put("msgType", "upload.invoice");
        ...
        req.put("srcReserve", "待开数据上传");

        req.put("qrCodeId","2018082981ed91875d984fa592782f6dc9c0dd82");
